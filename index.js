...
client.on("guildMemberAdd", member => {
    ...
    if (guvenilirlik === false) {
        ...
        hgkanal.send(`
<:tag:851170386556616786> Hoş geldin ${member} Biz de seni bekliyorduk, seninle beraber **${guild.memberCount}** kişi olduk! <:tag:851170386556616786>

Hesabını **${kuruluş}** tarihinde oluşturduğundan dolayı \`Şüpheli hesap\` engelimizi aştın!
Unutma <#${config.kurallar}> toplumun düzenini sağlamak için var! Kurallarımıza göz atmayı unutma. Tekrardan **Hoş Geldin** <:hey:850876685082951720>

https://discord.gg/bJxf76JXGh Kanalına giriş yaparak \`İsim\` ve \`Yaş\` belirterek kayıt olabilirsin **İyi Eğlenceler** <a:suprise:850876627248349264>
`)
    } else {
        member.roles.set([config.Suspecious])
        member.setNickname(`Yeni Hesap`)
        hgkanal.send(`
        <:tag:851170386556616786> Hoş geldin ${member}

seninle beraber **${guild.memberCount}** kişi olduk! <:tag:851170386556616786>

Hesabını **${kuruluş}** tarihinde oluşturduğundan dolayı \`Şüpheli hesap\` engelimizi aşamadın!
        `)
    }
});